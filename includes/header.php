...
<head>
    <title>TISHHA Consultants LLP - Inventory System</title>
    <meta charset="utf-8">
    ...
    <!-- Select2 (CDN fallback when local files are missing) -->
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <h1 class="navbar-brand" style="font-weight: 600; font-size: 1.2rem; color: #ffffff;">
                            Inventory System
                        </h1>
