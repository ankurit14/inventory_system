...
if(!isset($_GET['id'])) die("Invalid supplier");

$id = intval($_GET['id']);
$res = get_supplier($id);
$data = mysqli_fetch_assoc($res);

if(!$data) die("Supplier not found!");
...
<h2 class="text-center my-3">Edit Supplier</h2>
...
<form method="POST" id="supplierEditForm" novalidate>
    ...
    <button class="btn btn-primary w-100 mt-2">Update Supplier</button>
